...
class EmailSender:
    ...
    def send_email_to_student(self, recepient_email, message):
        try:
            ...
            self.configuration=self.config_reader.read_config()    #get configuration from config_reader

            # instance of MIMEMultipart Multipurpose Internet mail exchange
    ...
    def send_email_to_support(self,cust_name,cust_email,cust_contact,course_name,body):
            try:
                ...
                # creates SMTP session
                self.smtp = smtplib.SMTP('smtp.gmail.com', 587)   #default port no for gmail is 587
